module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        if (player.paused) return message.send(client.lang.get('commands.music.!song_resumed'), audio.embed);

        player.pause(true);
        return message.send(client.lang.get("commands.music.song_paused"), audio.embed);
    }
};